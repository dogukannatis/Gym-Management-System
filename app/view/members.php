        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="../view/members.php">Members</a>
              </li>
              <li class="nav-item">
...
if($result = mysqli_query($connection, $sql)){
       ...
       if(mysqli_num_rows($result) > 0){
           ...
           while ($row = mysqli_fetch_array($result)) {
            $join_link = "./join_package.php?package_id=" . $row["id"];
            $drop_link = "./drop_package.php?package_id=" . $row["id"];
               echo "<tr>";
               echo "<td>" . $row['id'] . "</td>";
               echo "<td>" . $row['name'] . "</td>";
               ...
               echo "<td>" . 20 - $row['quota'] . "</td>";
               if($row["id"] == $_SESSION["membership_id"]){
                echo "<td>" . " <a class='btn btn-danger' href=' " . $drop_link . "' role='button'>DROP</a>" . "</td>";
               }else{
                if($row["quota"] == 20){
                  echo "<td>" . " <a class='btn btn-secondary disabled' href='#' role='button'>FULL</a>" . "</td>";
                }else{
                  echo "<td>" . " <a class='btn btn-success' href=' " . $join_link . "' role='button'>JOIN</a>" . "</td>";
                }
