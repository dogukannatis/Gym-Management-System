...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="row text-center">
        <h1 class="pt-5 display-1"> Home Page!</h1> 
        <p class="text-muted lead">You logged in as <b><?php echo $_SESSION["username"] ?></b></p>
        <img src="../assets/images/home_img.jpg" class="img-fluid" style="height: 500px; width: 650px; margin:auto ">
      </div>
